  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'aurora-fade-in': 'aurora-fade-in 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'aurora-fade-out': 'aurora-fade-out 0.3s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'aurora-scale-in': 'aurora-scale-in 0.3s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'aurora-slide-up': 'aurora-slide-up 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'aurora-slide-down': 'aurora-slide-down 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
