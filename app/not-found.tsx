...
function NotFoundContent() {
  ...
  const safeLocale = locale === 'en' || locale === 'nl' || locale === 'fr' ? locale : 'en'
  const copy = FALLBACK[safeLocale]
  return (
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center px-4 aurora-theme">
      ...
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-foreground mb-2">{copy.pageNotFound}</h2>
