...
export type MethodResultRow = ValuationMethodResult & UnknownRecord
export type MethodResultMap = Record<string, MethodResultRow>
...
export function normalizeAdaptiveMethod(
  map: MethodResultMap,
...
export function enrichDcfMethod(
  map: MethodResultMap,
  valuationResult: UnknownRecord
): MethodResultMap {
  const dcf = map.dcf
...
export function pruneStaleDcfMethod(
  map: MethodResultMap,
  valuationResult: UnknownRecord,
  context?: ExtractValuationResultsContext | null
...
export function synthesizeMinimalValuationResultsMap(
  valuationResult: UnknownRecord,
  context?: ExtractValuationResultsContext | null
): MethodResultMap | null {
  const rc = getCanonicalReportContext(valuationResult)
