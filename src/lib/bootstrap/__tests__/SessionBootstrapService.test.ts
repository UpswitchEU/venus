/**
 * SessionBootstrapService bootstrap core Tests
 *
 * Covers identity, existing-report readiness, flow suggestions, and KBO prefill.
 *
 * @module lib/bootstrap/__tests__/SessionBootstrapService
 */

import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import type { BootstrapContext } from './SessionBootstrapService.testHarness'
import {
  mockAuthResolver,
  mockPrefillResolver,
  mockSessionResolver,
...
describe('SessionBootstrapService bootstrap core', () => {
