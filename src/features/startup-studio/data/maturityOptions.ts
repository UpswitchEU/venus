  ...
  sound_idea: {
    ...
    options: [
      ...
      },
      {
        level: 'basic',
        label: {
          en: 'Talked to 5–10 prospects, problem confirmed informally.',
          nl: 'Sprak met 5–10 prospects, probleem informeel bevestigd.',
        },
      },
      {
        level: 'strong',
    ...
    evidencePrompt: {
      en: 'Cite the strongest demand signal you have (e.g. "12 LOIs from logistics SMEs in Q4 2025").',
      nl: 'Noem het sterkste vraagsignaal dat je hebt (bv. "12 LOIs van logistieke KMO\'s in Q4 2025").',
    },
  },
  ...
  strategic_relationships: {
    ...
    options: [
      ...
      },
      {
        level: 'basic',
        label: {
          en: '1–2 informal design partners (no contract).',
          nl: '1–2 informele design partners (geen contract).',
        },
      },
      {
        level: 'strong',
        label: {
          en: '3+ signed LOIs or paid design partners.',
          nl: '3+ getekende LOIs of betaalde design partners.',
        },
      },
      {
        level: 'exceptional',
        label: {
          en: 'Channel partnership or marketplace listing with named accounts.',
          nl: 'Kanaalpartnerschap of marketplace-listing met benoemde accounts.',
        },
      },
    ],
    evidencePrompt: {
...
export const SCORECARD_FACTORS: Record<
  StudioScorecardKey,
  MilestoneCopy & { weight_pct: number }
> = {
  opportunity_size: {
    weight_pct: 30,
    title: { en: 'Market opportunity (size & growth)', nl: 'Marktopportuniteit (omvang & groei)' },
    subtitle: {
