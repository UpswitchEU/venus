...
import { unifiedSessionAPI, type Session } from '../services/api/session/UnifiedSessionAPI';
...
interface SessionStore {
  ...
  createSession: (type?: 'valuation' | 'onboarding' | 'assessment', data?: Record<string, any>) => Promise<Session>;
