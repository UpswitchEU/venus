...
describe('inferStartupSectorFromNace', () => {
  ...
  it.each(['64.19', '65.20', '66.12'])('maps financial activities %s to fintech', (code) => {
  ...
  it.each([
    ...
    '87.30',
    '88.91',
  ])('maps human-health activities %s to biotech_healthtech', (code) => {
  ...
  it.each([
    ...
    '29.10',
    '30.30',
  ])('maps manufacturing %s to hardware', (code) => {
  ...
  it.each([
    ...
    '52.29',
    '53.20',
  ])('maps transportation / logistics %s to marketplace', (code) => {
