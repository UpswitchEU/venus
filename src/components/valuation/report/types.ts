...
export interface EBITDAAdjustment {
  ...
  source?: 'yuki' | 'exact' | 'odoo' | 'manual' | 'suggestion';
...
export function convertApiResponseToReportData(
  ...
  return {
    ...
    reportedEbitda: apiResponse.reported_ebitda != null
      ...
      : undefined,
    latestNormalizedEbitda: apiResponse.latest_normalized_ebitda != null
    ...
    employeeCount: apiResponse.employee_count != null
      ...
      : undefined,
    foundedYear: apiResponse.founded_year != null
      ? Number(apiResponse.founded_year)
      : undefined,
