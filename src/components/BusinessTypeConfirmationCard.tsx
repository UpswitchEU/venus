    ...
    >
      <div className="max-w-[85%] mr-auto w-full">
        <div className="flex items-start gap-3">
          {/* Success Avatar */}
          <div className="flex-shrink-0 w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center border border-primary/30 shadow-lg shadow-primary/10 mt-1">
            <CheckCircle2 className="w-4 h-4 text-primary" />
          </div>

          <div className="flex flex-col gap-1 w-full">
            {/* Main Confirmation Card */}
            <div className="rounded-2xl rounded-tl-sm overflow-hidden border border-primary/20 shadow-lg backdrop-blur-sm bg-muted">
              ...
              <div className="p-5">
                <div className="flex items-start gap-4">
                  {/* Icon Box */}
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-muted to-muted/80 border border-foreground/20 flex items-center justify-center text-2xl shadow-inner">
                    {icon}
                  </div>
