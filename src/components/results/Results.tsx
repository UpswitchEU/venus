...
const ResultsComponent: React.FC<ResultsComponentProps> = ({ result }) => {
  ...
  // Render-side terminal failures surfaced via ensure-html (e.g. ValuationIQ
  // 413 on /reports/render). Keep this above the generic "no htmlReport"
  // fallback so the user gets an actionable message instead of "report not
  // available — HTML report was not generated by backend".
