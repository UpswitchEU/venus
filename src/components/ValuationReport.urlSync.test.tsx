  ...
  it('promotes a saved val_* concept to the durable report UUID without losing query state', async () => {
    ...
    await waitFor(() => {
      expect(replaceMock).toHaveBeenCalledWith(
        `/en/reports/${reportUuid}?source=mercury&tab=history&clientId=client-a&version=2&selected_method=upswitch_adaptive&locale=en&return_url=https%3A%2F%2Fwww.upswitch.app%2Fen%2Fadvisor`
      )
    })
  })
