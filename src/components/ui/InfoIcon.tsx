  ...
  return (
    <div className={`relative inline-flex items-center ${className}`}>
      <button
        ...
        className="text-foreground/30 hover:text-foreground/60 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 rounded-full"
      >
        <svg
          width={size}
          height={size}
