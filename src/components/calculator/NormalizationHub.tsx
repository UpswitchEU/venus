          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="text-center p-3 rounded-xl bg-foreground/[0.02] border border-foreground/[0.04]">
              ...
              <p className={cn(
                ...
                stats.totalAdjustment > 0 ? "text-success" : 
                stats.totalAdjustment < 0 ? "text-secondary" : "text-foreground/40"
              )}>
                {stats.totalAdjustment > 0 ? '+' : ''}{formatCurrency(stats.totalAdjustment)}
              </p>
            </div>
        ...
        <div className="shrink-0 px-4 md:px-6 py-4 border-t border-foreground/[0.06] bg-foreground/[0.01]">
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={cn("flex-1 gap-2", stats.pending > 0 && "bg-warning/15 text-warning border border-warning/30 hover:bg-warning/20")}
