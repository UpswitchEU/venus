...
export function useManualInputFormDataSync({
  ...
  if (formDataRef?.current != null) {
    ...
    Object.assign(formDataRef.current, {
      ...
      effective_multiple_override: formData.effective_multiple_override,
      effective_multiple_override_note: formData.effective_multiple_override_note,
      multiple_type_weights: formData.multiple_type_weights,
