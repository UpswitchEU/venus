...
export const DEFAULT_LEDGER_ACCOUNTS: LedgerAccount[] = [
  ...
  { code: '619', name: 'Overige diensten en diverse goederen', category: 'Diensten en diverse goederen' },
  ...
  { code: '624', name: 'Werkgeversbijdragen bovenwettelijke verzekeringen', category: 'Personeelskosten' },
  ...
  { code: '627', name: 'Uitzendkrachten en ter beschikking gesteld personeel', category: 'Personeelskosten' },
  ...
  { code: '630', name: 'Afschrijvingen oprichtingskosten', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '631', name: 'Afschrijvingen immateriële vaste activa', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '632', name: 'Afschrijvingen materiële vaste activa', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '633', name: 'Waardeverminderingen voorraden', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '634', name: 'Waardeverminderingen handelsvorderingen', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '635', name: 'Voorzieningen voor risico\'s en kosten', category: 'Afschrijvingen en waardeverminderingen' },
  { code: '636', name: 'Voorzieningen voor grote herstellings- en onderhoudswerken', category: 'Afschrijvingen en waardeverminderingen' },

  // ── 64x  Andere bedrijfskosten ──
  { code: '640', name: 'Bedrijfsbelastingen en -taksen', category: 'Andere bedrijfskosten' },
  { code: '641', name: 'Minderwaarden op courante realisatie vaste activa', category: 'Andere bedrijfskosten' },
  ...
  { code: '646', name: 'Bankkosten en financiële dienstverlening', category: 'Andere bedrijfskosten' },
  ...
  { code: '651', name: 'Waardeverminderingen financiële vaste activa', category: 'Financiële kosten' },
  ...
  { code: '663', name: 'Minderwaarden op realisatie vaste activa', category: 'Uitzonderlijke kosten' },
  ...
  { code: '740', name: 'Bedrijfssubsidies en compenserende bedragen', category: 'Andere bedrijfsopbrengsten' },
  { code: '741', name: 'Meerwaarden op courante realisatie vaste activa', category: 'Andere bedrijfsopbrengsten' },
  ...
  { code: '750', name: 'Opbrengsten uit financiële vaste activa', category: 'Financiële opbrengsten' },
  ...
  { code: '761', name: 'Terugneming van waardeverminderingen', category: 'Uitzonderlijke opbrengsten' },
  { code: '762', name: 'Terugneming van voorzieningen', category: 'Uitzonderlijke opbrengsten' },
  { code: '763', name: 'Meerwaarden op realisatie vaste activa', category: 'Uitzonderlijke opbrengsten' },
  { code: '764', name: 'Andere uitzonderlijke opbrengsten', category: 'Uitzonderlijke opbrengsten' },
];
