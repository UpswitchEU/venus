  ...
  (
    ...
    return (
      <div ref={ref} className={cn("w-full", className)} {...props}>
        ...
        >
          <div className={cn(sliderTrackVariants({ size, disabled }), "absolute inset-x-0 top-1/2 -translate-y-1/2")}>
            <motion.div
              className={cn(
          ...
          <motion.div
            className={cn(
              ...
              "focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-background",
              "transition-shadow",
              size === "sm" ? "w-4 h-4 border-2" : size === "lg" ? "w-6 h-6 border-[3px]" : "w-5 h-5 border-2",
              variant === "success" ? "border-success" : variant === "accent" ? "border-accent" : "border-primary",
