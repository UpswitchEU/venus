...
import { viewportPresets, type ViewportPreset } from './viewportPresets';
import { type AnimationVariant } from './animationVariants';

// Re-exports for convenience
export { viewportPresets, type ViewportPreset } from './viewportPresets';
export { animationVariants, type AnimationVariant } from './animationVariants';
