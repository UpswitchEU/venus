							...
							<div className='flex gap-2 pt-1'>
								{rejectLabel && onReject ? (
									<button
										...
										onClick={onReject}
										disabled={isInFlight}
										className='flex-1 px-3 py-1.5 text-foreground/40 hover:text-foreground/70 hover:bg-foreground/[0.04] active:bg-foreground/[0.06] transition-colors rounded-xl disabled:opacity-50'
									>
										{rejectLabel}
									</button>
								) : null}
								<button
									...
									className={cn(
										'flex-1 px-3 py-1.5 inline-flex items-center justify-center transition-colors rounded-xl disabled:opacity-50',
