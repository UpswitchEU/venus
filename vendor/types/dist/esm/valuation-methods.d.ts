...
export declare const DISTINCT_VALUATION_METHOD_COUNT: 10;
...
export declare const USER_WEIGHT_VALUATION_METHOD_KEYS: readonly ["upswitch_adaptive", "ebitda_multiple", "omzet_multiple", "dcf", "sde_multiple", "arr_multiple", "adjusted_nav", "fiscal_4x", "startup_valuation", "liquidation_analysis", "revenue_multiple"];
export type UserWeightValuationMethodKey = (typeof USER_WEIGHT_VALUATION_METHOD_KEYS)[number];
export declare const NON_COMBINABLE_VALUATION_METHOD_KEYS: readonly ["startup_valuation", "liquidation_analysis"];
export type NonCombinableValuationMethodKey = (typeof NON_COMBINABLE_VALUATION_METHOD_KEYS)[number];
export declare const VALUATION_PRIMARY_OMNI_METHOD_ORDER: readonly ["upswitch_adaptive", "arr_multiple", "ebitda_multiple", "omzet_multiple", "revenue_multiple", "sde_multiple", "dcf", "adjusted_nav", "fiscal_4x", "liquidation_analysis"];
export type ValuationPrimaryOmniMethodKey = (typeof VALUATION_PRIMARY_OMNI_METHOD_ORDER)[number];
export declare const OMNI_CALC_PATCHABLE_METHODS: readonly ["upswitch_adaptive", "ebitda_multiple", "dcf", "sde_multiple", "arr_multiple", "omzet_multiple", "revenue_multiple", "adjusted_nav", "fiscal_4x", "startup_valuation", "liquidation_analysis"];
